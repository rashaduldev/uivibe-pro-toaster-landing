      ...
      <div className="container-x grid items-start gap-10 lg:grid-cols-2">
        <div>
          ...
          <p className="h-section-sub">
            Drop a single <code className="code text-indigo-300">&lt;script&gt;</code> tag from
            unpkg or jsDelivr. The global <code className="code text-indigo-300">window.Toast</code>
