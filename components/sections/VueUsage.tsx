      ...
      <div className="container-x grid items-start gap-10 lg:grid-cols-2">
        <div>
          ...
          <p className="h-section-sub">
            The same singleton works inside <code className="code text-blue-300">setup()</code>,
            composables, or any client-side script. Configure once on <code className="code text-blue-300">onMounted</code>
            {" "}and you&apos;re done.
          </p>
